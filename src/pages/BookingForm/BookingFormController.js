...
export const QUALIFIED_COUNSELLOR_PSYCHOTHERAPIST_SLUG =
  "qualified-counsellor-psychotherapist";
export const PREMIUM_COUNSELLOR_PSYCHOTHERAPIST_SLUG =
  "premium-service-counsellor-psychotherapist";
export const QUALIFIED_THERAPIST = "qualified-therapist";
export const PREMIUM_SERVICE_THERAPIST = "premium-service-therapist.";
...
export const APPOINTMENT_SERVICES_PRICING = {
  [QUALIFIED_COUNSELLOR_PSYCHOTHERAPIST_SLUG]: {
    name: "Qualified Counsellor/Psychotherapist",
    options: {
      [FACE_2_FACE_SLUG]: { name: "Face to Face", price: 75 },
      [REMOTE_SLUG]: {
  ...
  [PREMIUM_COUNSELLOR_PSYCHOTHERAPIST_SLUG]: {
    name: "Premium Service Counsellor/Psychotherapist.",
    options: {
      [FACE_2_FACE_SLUG]: { name: "Face to Face", price: 110 },
      [REMOTE_SLUG]: {
        name: "Remote Audio/Video Call",
        price: 100,
      },
...
class BookingFormController extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      isLoading: false,
      selectedService: QUALIFIED_COUNSELLOR_PSYCHOTHERAPIST_SLUG,
